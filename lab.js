...
if (temperature > 80 && rain === true){
  ...
  console.log ("You should wear a t-shirt and sunscreen")
} else if (temperature >= 60 || temperature <= 80 && rain === false){
  console.log ("You should wear a pants and a shirt")
} else (temperature <= 60 && rain === false){
  console.log ("You should wear a jacket and pants")
}
